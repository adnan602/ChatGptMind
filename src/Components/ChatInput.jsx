...
export const ChatInput = () => {
  ...
  const onSend = async () => {
    ...
    if (!title) {
      ...
      dispatch(types.SET_ACTIVE_CHAT, { title });
                ...
                <button
                  ...
                  class="inline-flex items-center disable
                                 ...
                                 focus:ring-purple-500 disabled:bg-gray-400 disabled:cursor-default
                                  transition-colors whitespace-nowrap space-x-1 h-[36px]"
                >
                  →
                </button>
              </div>
