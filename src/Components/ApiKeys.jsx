                  ...
                  <div class="mt-2 text-gray-800  text-left text-sm">
                    ...
                    {keyError ? (
                      <div class="text-sm text-center text-red-500">
                        Invalid API key. Please make sure your API key is still
                        working properly.
                      </div>
                    ) : (
                      ""
                    ...
                    <div class="my-2 text-center space-x-2 flex items-center justify-center">
                      <button
                        ...
                        onClick={onSave}
                        class="inline-flex items-center bg-purple-600 px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white  hover:bg-purple-700  space-x-1 disabled:bg-gray-400"
                      ...
                      <button
                        onClick={onClose}
                        class="inline-flex items-center px-4 py-2 text-sm  border font-medium rounded-md shadow-sm text-gray-500   space-x-1"
