    ...
    <div>
      <div className="mt-10">
        <div className="text-sm mt-10 text-center space-y-4">
          <div>To get started, enter your OpenAI API key below.</div>
          <div>
            <Button
                ...
                <div>
                  <div class="mt-2 text-gray-800 dark:text-white text-left text-sm">
                    ...
                    <div class="my-2 text-center space-x-2 flex items-center justify-center">
                      <button
                      onClick={onSave}
                        class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 space-x-1 disabled:bg-gray-400"
                        fdprocessedid="1oi5f6"
                      >
                        <svg
                          stroke="currentColor"
                          fill="currentColor"
                      ...
                      <button
                        onClick={onClose}
                        class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md shadow-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 space-x-1"
                        fdprocessedid="8w0icl"
                      >
                        <span>Cancel</span>
                      </button>
                    </div>
