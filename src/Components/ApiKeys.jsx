                ...
                <div className="text-sm mt-10 text-center space-y-4">
                    ...
                    <div>
                        <Button className="inline-flex items-center 
                            ...
                            shadow-md bg-purple-600 text-white 
                            ...
                            <div class="inline-block w-full align-bottom bg-white dark:bg-zinc-900 pt-0   pb-4 text-left  transform transition-all  sm:align-middle p-6 overflow-hidden sm:max-w-sm opacity-100 translate-y-0 sm:scale-100">
                                <div>
                                    <div class="mt-2 text-gray-800 dark:text-white text-left text-sm">
                                        ...
                                        <div class="my-4">
                                            <input type="text" placeholder="sk-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-zinc-700" autocomplete="off" value="" fdprocessedid="yovm6b" />

                                        </div>
                                        <div class="my-2 text-center space-x-2 flex items-center justify-center">
                                            <button class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 space-x-1 disabled:bg-gray-400" fdprocessedid="1oi5f6">
                                            ...
                                            <button onClick={onClose} class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md shadow-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 space-x-1" fdprocessedid="8w0icl"><span>
                                                Cancel</span></button>
                                        </div>
