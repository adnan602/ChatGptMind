...
export const Main = () => {
    return (
        <div>
            <div className="flex flex-1 flex-col lg:pl-80 lg:pr-80">
                            ...
                            <div className="py-8">
                                ...
                                <div className="my-4 text-center flex items-center justify-center flex-wrap gap-2 px-4">
                                    ...
                                    items-center justify-center 
                                     px-4 py-2 text-sm shadow-md bg-amber-600 text-white hover:bg-amber-500
                                      transition-all active:bg-amber-600 group space-x-2"
                                        fdprocessedid="584ga">
                                        <svg
                                            stroke="currentColor"
                                            fill="currentColor"
                                        ...
                                        >
                                            ...
                                            ></path></svg
                                        ><span>Select Character</span></button>
                                    <button className="inline-flex items-center justify-center 
                                     px-4 py-2 text-sm shadow-md bg-teal-600 
                                     text-white hover:bg-teal-500 transition-all active:bg-teal-600 group space-x-2"
                                        fdprocessedid="c3sbua"
                                    >
                                        <svg
                                            stroke="currentColor"
                                            fill="currentColor"
                                        ...
                                        >
                                            ...
                                            ></path></svg
                                        ><span>Model Settings</span></button
                                    ><button
                                        className="inline-flex items-center 
                                        justify-center  px-4
                                         py-2 text-sm shadow-md 
                                         bg-fuchsia-600 text-white 
                                         hover:bg-fuchsia-500 transition-all active:bg-fuchsia-600 group space-x-2"
                                        fdprocessedid="zwu7me"
                                    >
                                        <svg
                                            stroke="currentColor"
                                            fill="currentColor"
                                        ...
                                        <div className="w-full">
                                            <div>
                                                <div className="text-gray-500 text-xs mb-1">
                                                    Model: gpt-3.5-turbo<br />System Instruction: You
